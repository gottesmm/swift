...
```
$ swift/utils/build-script --swiftpm --llbuild --install-swift --install-swiftpm --install-llbuild --toolchain-benchmarks
```
...
```
swift_source/benchmark$ swift build -configuration release
swift_source/benchmark$ .build/release/SwiftBench
