...
function(_swift_benchmark_get_stdlib_dependencies outvar)
  set(dependencies "swift")
  foreach(dependency ${UNIVERSAL_LIBRARY_NAMES_${SWIFT_BENCHMARK_COMPILE_PLATFORM}})
    string(FIND "${dependency}" "Unittest" find_output)
    if("${find_output}" STREQUAL "-1")
      list(APPEND dependencies "${stdlib_dependency}")
    endif()
  endforeach()
...
function(_swift_benchmark_compile)
  ...
  if(IS_SWIFT_BUILD)
    _swift_benchmark_get_stdlib_dependencies(stdlib_dependencies)
  endif()
...
function(_swift_benchmark_get_platforms_sdks platform_outvar sdk_outvar)
