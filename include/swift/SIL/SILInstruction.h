...
protected:
  ...
  ApplyInstBase(SILInstructionKind kind, SILDebugLocation DebugLoc,
      ...
      : Base(kind, DebugLoc, baseArgs...), SubstCalleeType(substCalleeType),
        ...
        HasArgumentLocs(!argLocs.empty()), NumCallArguments(args.size()),
    ...
    assert((argLocs.empty() || argLocs.size() == args.size()) &&
           "argLocs, if supplied, must be parallel to args");
...
private:
  PartialApplyInst(SILDebugLocation DebugLoc, SILValue Callee,
                   ...
                   ArrayRef<SILValue> Args,
                   ArrayRef<SILValue> TypeDependentOperands,
                   ArrayRef<SILLocation> ArgLocs, SILType ClosureType,
                   StackAllocationIsNested_t IsNested,
                   const GenericSpecializationInformation *SpecializationInfo);
...
class TryApplyInst final
  ...
  TryApplyInst(SILDebugLocation debugLoc, SILValue callee,
               ...
               ArrayRef<SILValue> args,
               ArrayRef<SILValue> typeDependentOperands,
               ArrayRef<SILLocation> argLocs, SILBasicBlock *normalBB,
