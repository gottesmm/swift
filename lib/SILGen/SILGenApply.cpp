...
struct AccessorBaseArgPreparer final {
  ...
  AccessorBaseArgPreparer(SILGenFunction &SGF, SILLocation loc, ManagedValue base,
                          CanType baseFormalType, SILDeclRef accessor);
...
AccessorBaseArgPreparer::AccessorBaseArgPreparer(SILGenFunction &SGF,
                                                 ...
                                                 CanType baseFormalType,
                                                 SILDeclRef accessor)
    : SGF(SGF), loc(loc), base(base), baseFormalType(baseFormalType), accessor(accessor),
