// RUN: %target-swift-frontend  -strict-concurrency=complete -disable-availability-checking -parse-as-library %s -emit-sil -o /dev/null -verify -verify-additional-prefix complete- %s
// RUN: %target-swift-frontend  -strict-concurrency=complete -disable-availability-checking -parse-as-library %s -emit-sil -o /dev/null -verify -verify-additional-prefix sns- -enable-experimental-feature SendNonSendable %s
