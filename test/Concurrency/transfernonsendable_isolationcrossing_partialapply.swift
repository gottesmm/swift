...
actor ProtectsNonSendable {
  ...
  nonisolated func testParameter(_ nsArg: NonSendableKlass) async {
    self.assumeIsolated { isolatedSelf in
      ...
      // expected-concurrent-note @-1 {{'nsArg' is captured by a actor-isolated closure. actor-isolated uses in closure may race against code in the current task}}
      // expected-ni-note @-2 {{'nsArg' is captured by a actor-isolated closure. actor-isolated uses in closure may race against code in the current task}}
    }
  }
  ...
  nonisolated func testParameterMergedIntoLocal(_ nsArg: NonSendableKlass) async {
    ...
    self.assumeIsolated { isolatedSelf in
      ...
      // expected-concurrent-note @-1 {{'l' is captured by a actor-isolated closure. actor-isolated uses in closure may race against code in the current task}}
      // expected-ni-note @-2 {{'l' is captured by a actor-isolated closure. actor-isolated uses in closure may race against code in the current task}}
    }
  }
