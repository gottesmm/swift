...
func transferLetNonTransferrableSquelched(_ ns: NonSendableKlass) async {
  ...
  // expected-note @-2 {{sending 'ns' to main actor-isolated global function 'transferToMainDirect' risks causing data races between main actor-isolated code and code in the current task}}
  ...
  // expected-note @-2 {{sending 'ns3' to main actor-isolated global function 'transferToMainDirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}

  await transferToMainDirect(ns4)
  // expected-warning @-1 {{sending 'ns4' risks causing data races}}
  // expected-note @-2 {{sending 'ns4' to main actor-isolated global function 'transferToMainDirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}

  await transferToMainIndirect(ns)
  // expected-warning @-1 {{sending 'ns' risks causing data races}}
  // expected-note @-2 {{sending 'ns' to main actor-isolated global function 'transferToMainIndirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
  ...
  // expected-warning @-1 {{sending 'ns3' risks causing data races}}
  // expected-note @-2 {{sending 'ns3' to main actor-isolated global function 'transferToMainIndirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}

  await transferToMainIndirect(ns4)
  // expected-warning @-1 {{sending 'ns4' risks causing data races}}
  // expected-note @-2 {{sending 'ns4' to main actor-isolated global function 'transferToMainIndirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
}
...
func transferNonTransferrableClassField(_ ns: NonSendableKlass) async {
  ...
  // expected-note @-2 {{sending 'ns2.field' to main actor-isolated global function 'transferToMainDirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
  await transferToMainIndirect(ns2.field!)
  // expected-warning @-1 {{sending 'ns2.field' risks causing data races}}
  // expected-note @-2 {{sending 'ns2.field' to main actor-isolated global function 'transferToMainIndirect' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
}
...
func testConsumingTransfer(_ ns: NonSendableKlass) async {
  ...
  // expected-warning @-1 {{sending 'ns' risks causing data races}}
  // expected-note @-2 {{sending 'ns' to main actor-isolated global function 'transferToMainDirectConsuming' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}

  await transferToMainIndirectConsuming(ns)
  // expected-warning @-1 {{sending 'ns' risks causing data races}}
  // expected-note @-2 {{sending 'ns' to main actor-isolated global function 'transferToMainIndirectConsuming' risks causing data races between main actor-isolated code and code in the current task}}
  // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
...
struct NonIsolatedUnsafeFieldNonSendableStruct {
  ...
  func test() async {
    ...
    // expected-note @-2 {{sending 'self.letObject' to main actor-isolated global function 'transferToMainDirect' risks causing data races between main actor-isolated code and code in the current task}}
    // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
    await transferToMainDirect(varObject)
    // expected-warning @-1 {{sending 'self.varObject' risks causing data races}}
    // expected-note @-2 {{sending 'self.varObject' to main actor-isolated global function 'transferToMainDirect' risks causing data races between main actor-isolated code and code in the current task}}
    // expected-complete-warning @-3 {{passing argument of non-Sendable type 'NonSendableKlass' into main actor-isolated context may introduce data races}}
  }
...
class NonIsolatedUnsafeFieldGenericKlass<T> { // expected-complete-note 4{{}}
  ...
  func test() async {
    ...
    // expected-note @-2 {{sending 'self.letAddressOnly' to main actor-isolated global function 'transferToMainIndirect' risks causing data races between main actor-isolated code and code in the current task}}
    // expected-complete-warning @-3 {{passing argument of non-Sendable type 'T?' into main actor-isolated context may introduce data races}}
    ...
    // expected-note @-2 {{sending value of non-Sendable type 'T?' to main actor-isolated global function 'transferToMainIndirect' risks causing races in between code in the current task and main actor-isolated uses}}
  }
...
func closureTests() async {
  ...
  // Parameter accessible to code in the current task + nonisolated(unsafe) capture. Each send of the
  // closure triggers a SentNeverSendable error for ns (accessible to code in the current task), while
