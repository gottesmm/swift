...
// CHECK: [[BORROWED_MARKED_BOX:%.*]] = begin_borrow [[MARKED_BOX]]
// CHECK: [[ADDR:%.*]] = project_box [[BORROWED_MARKED_BOX]] : ${ var S }, 0
...
// CHECK: bb0:
// CHECK: %[[BOX:.*]] = alloc_box ${ var S }, var, name "s"
// CHECK: [[BORROWED_BOX:%.*]] = begin_borrow %[[BOX]]
// CHECK: %[[ADDRS:.*]] = project_box [[BORROWED_BOX]] : ${ var S }, 0
