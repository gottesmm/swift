...
// CHECK:         [[BVAR:%.*]] = begin_borrow [[VAR]]
// CHECK:         [[PVAR:%.*]] = project_box [[BVAR]]
...
func test_open_existential_semantics(_ guaranteed: Error,
  ...
  // CHECK: [[BIMMEDIATE_BOX:%.*]] = begin_borrow [[IMMEDIATE_BOX]]
  // CHECK: [[PB:%.*]] = project_box [[BIMMEDIATE_BOX]]
  // GUARANTEED: [[IMMEDIATE_BOX:%.*]] = alloc_box ${ var Error }
  // GUARANTEED: [[BIMMEDIATE_BOX:%.*]] = begin_borrow [[IMMEDIATE_BOX]]
  // GUARANTEED: [[PB:%.*]] = project_box [[BIMMEDIATE_BOX]]
