...
// CHECK: [[B_THIS:%.*]] = begin_borrow [[THIS]]
// CHECK: [[PB_THIS:%.*]] = project_box [[B_THIS]]
...
// CHECK-NEXT: [[B_SELF:%.*]] = begin_borrow [[SELF]]
// CHECK-NEXT: [[PB:%.*]] = project_box [[B_SELF]]
