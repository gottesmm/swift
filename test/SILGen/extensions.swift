...
// CHECK-NEXT: [[B_UNINIT_SELF_BOX:%.*]] = begin_borrow [[UNINIT_SELF_BOX]]
// CHECK-NEXT: [[SELF_ADDR:%.*]] = project_box [[B_UNINIT_SELF_BOX]] : $<τ_0_0> { var Box<τ_0_0> } <T>
...
// CHECK-NEXT: end_borrow [[B_UNINIT_SELF_BOX]]
