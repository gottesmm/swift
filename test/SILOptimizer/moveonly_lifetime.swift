// RUN: %target-swift-emit-sil -module-name moveonly_lifetime -o /dev/null -Xllvm -sil-print-canonical-module -Onone -verify -enable-experimental-move-only %s 2>&1 | %FileCheck %s
