...
EXPECTED_OPTIONS = [
    ...
    DisableOption('--skip-build-android-stage2', dest='build_android_stdlib_stage2'),
    DisableOption('--skip-build-benchmarks-stage2', dest='build_benchmarks_stdlib_stage2'),
    DisableOption('--skip-build-cygwin-stage2', dest='build_cygwin_stdlib_stage2'),
    DisableOption('--skip-build-freebsd-stage2', dest='build_freebsd_stdlib_stage2'),
    DisableOption('--skip-build-ios-stage2', dest='build_ios_stdlib_stage2'),
    DisableOption('--skip-build-ios-device-stage2', dest='build_ios_device_stdlib_stage2'),
    DisableOption('--skip-build-ios-simulator-stage2',
                  dest='build_ios_simulator_stdlib_stage2'),
    DisableOption('--skip-build-linux-stage2', dest='build_linux_stdlib_stage2'),
    DisableOption('--skip-build-osx-stage2', dest='build_osx_stdlib_stage2'),
    DisableOption('--skip-build-tvos-stage2', dest='build_tvos_stdlib_stage2'),
    DisableOption('--skip-build-tvos-device-stage2', dest='build_tvos_device_stdlib_stage2'),
    DisableOption('--skip-build-tvos-simulator-stage2',
                  dest='build_tvos_simulator_stdlib_stage2'),
    DisableOption('--skip-build-watchos-stage2', dest='build_watchos_stdlib_stage2'),
    DisableOption('--skip-build-watchos-device-stage2',
                  dest='build_watchos_device_stdlib_stage2'),
    DisableOption('--skip-build-watchos-simulator-stage2',
                  dest='build_watchos_simulator_stdlib_stage2'),
