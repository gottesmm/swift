# swift_build_support/products/stage2_swift.py ------------------*- python -*-
#
...
from ..host_specific_configuration import \
    Stage2HostSpecificConfiguration

class Stage2Swift(cmake_product.CMakeProduct):
...
updated without updating swift.py?")
    ...
    def should_build(self, host_target):
        ...
        """
        return self.args.build_stage2_swift
    ...
    def build(self, host_target):
        ...
        #                              self.args.swift_stdlib_assertions)
        ...
        self.cmake_options.define('LLVM_ENABLE_ASSERTIONS:BOOL', self.args.swift_assertions)
        ...
        self.cmake_options.define('SWIFT_ANALYZE_CODE_COVERAGE:BOOL', self.args.swift_analyze_code_coverage)
        #     -DSWIFT_STDLIB_BUILD_TYPE:STRING="${SWIFT_STDLIB_BUILD_TYPE}"
        self.cmake_options.define('SWIFT_STDLIB_BUILD_TYPE', self.args.swift_stdlib_build_variant)
        #     -DSWIFT_STDLIB_ASSERTIONS:BOOL=$(true_false "${SWIFT_STDLIB_ENABLE_ASSERTIONS}")
        self.cmake_options.define('SWIFT_STDLIB_ASSERTIONS:BOOL', self.args.swift_stdlib_assertions)
        ...
        # MG: For full stage 2 include the tools.
        #self.cmake_options.define('SWIFT_INCLUDE_TOOLS:BOOL', True) # MG: TODO
        self.cmake_options.define('SWIFT_INCLUDE_TOOLS:BOOL', False) # MG: TODO
        #     -DSWIFT_BUILD_REMOTE_MIRROR:BOOL=$(true_false "${BUILD_SWIFT_REMOTE_MIRROR}")
        self.cmake_options.define('SWIFT_BUILD_REMOTE_MIRROR:BOOL', True) # MG: TODO
        ...
        self.cmake_options.define('SWIFT_BUILD_DYNAMIC_STDLIB:BOOL', self.args.stage2_build_swift_dynamic_stdlib)
        #     -DSWIFT_BUILD_STATIC_STDLIB:BOOL=$(true_false "${BUILD_SWIFT_STATIC_STDLIB}")
        self.cmake_options.define('SWIFT_BUILD_STATIC_STDLIB:BOOL', self.args.stage2_build_swift_static_stdlib)
        #     -DSWIFT_BUILD_DYNAMIC_SDK_OVERLAY:BOOL=$(true_false "${BUILD_SWIFT_DYNAMIC_SDK_OVERLAY}")
        self.cmake_options.define('SWIFT_BUILD_DYNAMIC_SDK_OVERLAY:BOOL', self.args.stage2_build_swift_dynamic_sdk_overlay)
        #     -DSWIFT_BUILD_STATIC_SDK_OVERLAY:BOOL=$(true_false "${BUILD_SWIFT_STATIC_SDK_OVERLAY}")
        self.cmake_options.define('SWIFT_BUILD_STATIC_SDK_OVERLAY:BOOL', self.args.stage2_build_swift_static_sdk_overlay)
        ...
        # fi
        try:
            config = Stage2HostSpecificConfiguration(host_target, self.args)
        ...
        #     )
        # fi
        self.cmake_options.define('SWIFT_PRIMARY_VARIANT_SDK:STRING', self.args.stage2_swift_primary_variant_sdk)
        ...
        #     )
        # fi
        self.cmake_options.define('SWIFT_PRIMARY_VARIANT_ARCH:STRING', self.args.stage2_swift_primary_variant_arch)
        ...
        self.cmake_options.define('SWIFT_INSTALL_COMPONENTS:STRING',
                                  self.args.stage2_swift_install_components)
    ...
    def should_test(self, host_target):
        ...
        return self.args.test_stage2_swift
    ...
    def should_install(self, host_target):
        ...
        arguments.
        """
        return self.args.install_all or self.args.install_stage2_swift
